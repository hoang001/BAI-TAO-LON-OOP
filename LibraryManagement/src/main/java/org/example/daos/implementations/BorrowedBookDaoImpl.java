...
public class BorrowedBookDaoImpl implements BorrowedBookDao {
     ...
     */
    @Override
    public boolean borrowBook(int bookId, String userName, LocalDate borrowDate, LocalDate returnDate) throws SQLException {
        String query = "INSERT INTO BorrowedBooks (bookId, userName, borrowDate, returnDate) VALUES (?, ?, ?, ?)";
     ...
     */
    @Override
    public List<BorrowedBookEntity> findBorrowedBooksByUser(String userName, LocalDate startDate, LocalDate endDate) throws SQLException {
    ...
    @Override
    public List<BorrowedBookEntity> findOverdueBooksByUser(String userName, LocalDate returnDate) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
            ...
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                while (resultSet.next()) {
                    BorrowedBookEntity overdueBook = new BorrowedBookEntity(
                        resultSet.getInt("borrowedBookId"),
                        resultSet.getInt("bookId"),
                        resultSet.getString("userName"),
                        resultSet.getObject("borrowDate", LocalDate.class),
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
            ...
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                while (resultSet.next()) {
                    ...
                    book.setReturnDate(resultSet.getDate("returnDate") != null
    ...
    public int findBorrowedBooksCountByIsbn(String isbn) throws SQLException {
        String query = "SELECT COUNT(bookId) AS borrowed_count" +
                       "FROM borrowedBooks " +
