...
public interface BorrowedBookDao {
   ...
   */
  boolean borrowBook(
      int borrowedBookId, String userName, LocalDate borrowDate, LocalDate returnDate)
      throws SQLException;
   ...
   * @throws SQLException nếu có lỗi xảy ra trong quá trình truy vấn cơ sở dữ liệu.
   */
  List<BorrowedBookEntity> findBorrowedBooksByUser(
   ...
   * @throws SQLException nếu có lỗi xảy ra trong quá trình truy vấn cơ sở dữ liệu.
   */
  List<BorrowedBookEntity> findOverdueBooksByUser(String userName, LocalDate currentDate)
      throws SQLException;
