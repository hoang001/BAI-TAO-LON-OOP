...
public class BookEntity extends BaseEntity {
  ...
  /**
   * Khởi tạo một đối tượng BookEntity mặc định. Khởi tạo đối tượng BookEntity mà không cần thông
   * tin đầu vào.
   */
  public BookEntity() {}
   ...
   */
  public BookEntity(int bookId, String isbn, String title,
      String authorName, String publisherName, int publicationYear,
      String categoryName, String bookCoverDirectory, boolean available, int quantity) {
    super(bookId);
    this.isbn = isbn;
    this.title = title;
